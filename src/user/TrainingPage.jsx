      ...
      <div className="  px-4 sm:px-6 py-12">
        <div className="max-w-4xl mx-auto text-center mb-12 space-y-4">
          <Typography className="text-gray-700 font-light text-lg">
            ...
            culture of vocational training in Nepal. Our training programs
            empower aspiring baristas with hands-on skills and real-world coffee
            knowledge to help them excel in the café industry.
          </Typography>
        </div>
